 ...
 * @summary Create a listing
 */
export const useCreateListing = <TError = ErrorResponse, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof createListing>>,
      TError,
 ...
 * @summary Update a listing (owner only)
 */
export const useUpdateListing = <TError = ErrorResponse, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof updateListing>>,
      TError,
 ...
 * @summary Delete a listing (owner only)
 */
export const useDeleteListing = <TError = ErrorResponse, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof deleteListing>>,
      TError,
